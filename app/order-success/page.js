    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="bg-white p-8 md:p-12 rounded-[2.5rem] md:rounded-[3rem] shadow-sm max-w-lg w-full text-center border border-gray-100">
        ...
        <div className="space-y-4">
          <Link
            href="/account"
            className="flex items-center justify-center gap-3 w-full bg-black text-white py-4 rounded-xl font-black uppercase tracking-widest text-[12px] md:text-xs hover:bg-gray-800 transition shadow-xl"
          >
          ...
          <Link
            href="/shop"
            className="flex items-center justify-center gap-3 w-full bg-white border-2 border-gray-100 text-gray-900 py-4 rounded-xl font-black uppercase tracking-widest text-[12px] md:text-xs hover:bg-gray-50 transition"
          >
