  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6">
      <div className="relative">
        ...
        <div className="absolute inset-0 w-20 h-20 md:w-24 md:h-24 rounded-full border-[3px] border-transparent border-b-blue-600 animate-spin-reverse opacity-50"></div>
      ...
      <div className="mt-12 text-center">
        ...
        <p className="text-[9px] md:text-[10px] font-bold uppercase tracking-widest text-gray-400 animate-pulse">
